...
This project is indexed by GitNexus as **app-backtrack** (1016 symbols, 2266 relationships, 63 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
