...
This project is indexed by GitNexus as **app-backtrack** (3380 symbols, 5316 relationships, 106 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
