...
This project is indexed by GitNexus as **app-backtrack** (1008 symbols, 2284 relationships, 64 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
