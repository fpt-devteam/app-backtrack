...
This project is indexed by GitNexus as **app-backtrack** (3489 symbols, 5528 relationships, 115 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
