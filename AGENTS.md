...
This project is indexed by GitNexus as **app-backtrack** (3389 symbols, 5372 relationships, 111 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
